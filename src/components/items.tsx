...
export function ItemHeader({ title }: { title: string }) {
  return (
    <div className="bg-slate-500 rounded-sm px-0.5 text-center">
...
export function Item({ title, value, isLink = false, showCopy = false }: ItemProps) {
  return (
    <div className="text-center p-3 space-y-1 rounded-sm bg-gray-800">
