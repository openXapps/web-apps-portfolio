...
function AboutMeTitle({ title }: { title: string }) {
  return (
    <div className="bg-slate-400 rounded-sm pl-0.5">
  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="space-y-1">
        <h4 className="text-xl">Senior BMC Helix Remedy Developer</h4>
        <h4 className="text-xl">Senior Integration Specialist</h4>
      </div>
